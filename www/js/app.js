...
function cordovaOauthLogin() {
    ...
    window.open(
        'https://oauth.opskins.com/v1/authorize/?client_id=57f2f95d10af&state=' + getCookie('user_id_reg') + '&duration=permanent&mobile=1&scope=identity+trades+items+manage_items&response_type=code',
        '_self',
        'location=no'
    );
}
